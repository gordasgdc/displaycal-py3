...
class File:
    ...
    def update_resources_from_datafile(
        self, srcpath, type_, names=None, languages=None
    ):
    ...
    def update_resources_from_resfile(
        self, srcpath, types=None, names=None, languages=None
    ):
...
def UpdateResourcesFromResFile(
    dstpath, srcpath, types=None, names=None, languages=None
):
